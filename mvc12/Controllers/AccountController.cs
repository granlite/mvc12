...
namespace muscshop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult SignUp(User newUser)
        {
            ...
            var text = $"To finish registration go to: {urlHost}/Account/Confirmation/{user.Confirmation}";
        ...
        private void SendConfirmation(string to, string text)
        {
            ...
            mail.From = new System.Net.Mail.MailAddress("gransare@gmail.com");
            mail.To.Add(to);
        ...
        private ActionResult SendRecovery2(User user)
        {
            Uri uri = new Uri(Request.Url.AbsoluteUri);
            var urlHost = uri.Scheme + Uri.SchemeDelimiter + uri.Host + ":" + uri.Port;
            var text = $"To restore password go to: {urlHost}/Account/Recovery/{user.PassRecovery}";
